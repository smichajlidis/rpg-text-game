...
class ApproachingChapelSuccess: public InteractionWithNPC {

public:
    ApproachingChapelSuccess(std::shared_ptr<Player> player = nullptr, std::shared_ptr<GameState> game_state = nullptr,
