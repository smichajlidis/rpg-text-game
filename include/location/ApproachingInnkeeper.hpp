...
public:
    ApproachingInnkeeper(std::shared_ptr<Player> player = nullptr, std::shared_ptr<GameState> game_state = nullptr,
        const std::string& description = "- Hello stranger, what do you wish?",
