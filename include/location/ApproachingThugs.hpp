...
public:
    ApproachingThugs(std::shared_ptr<Player> player, std::shared_ptr<GameState> game_state = nullptr,
    const std::string& description = "Hello stranger, do you want to cross the bridge? No problem.. if you pay 1000 piece of gold. Deal?",
