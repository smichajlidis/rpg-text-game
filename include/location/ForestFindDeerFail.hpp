#ifndef _FORESTFINDDEERFAIL_HPP_
#define _FORESTFINDDEERFAIL_HPP_

#include "../InteractionWithNPC.hpp"

class ForestFindDeerFail: public InteractionWithNPC {

public:
    ForestFindDeerFail(std::shared_ptr<Player> player, std::shared_ptr<GameState> game_state = nullptr,
