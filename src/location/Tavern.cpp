...
Tavern::Tavern(std::shared_ptr<GameState> game_state, const std::string& description, const std::string& choice_1, const std::string& choice_2, const std::string& choice_3, const std::string& choice_4, const std::string& choice_5)
    ...
    game_state->addLocation("innkeeper", std::make_shared<Innkeeper>());
    game_state->addLocation("gamblers", std::make_shared<Gamblers>());
    game_state->addLocation("approaching_priest", std::make_shared<ApproachingPriest>());
    game_state->addLocation("ladies", std::make_shared<Ladies>());
