#include <iostream>
#include "../../include/location/thugs.h"

Location* Thugs::making_a_choice() {
    char choice {};
    std::cin>>choice;
    switch (choice) {
...
Thugs::Thugs(std::string name_val, std::string description_val, std::string choice_1_val, std::string choice_2_val, std::string choice_3_val)
